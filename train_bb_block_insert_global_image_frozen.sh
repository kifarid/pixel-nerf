...
export EXP_NAME=block_insert_global_image_frozen_mask'_'$SLURM_ARRAY_TASK_ID
python3.8 -m main -n $EXP_NAME \
--base configs/default_mv_lgn.yaml configs/exp/ravens_global_image_frozen.yaml \
-t \
